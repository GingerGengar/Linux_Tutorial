...
%Seperator
%Seperator
\subsubsection{Terminal Related}
\begin{comment}
\end{comment}
\begin{tabular}{|m{\tabsize}|m{\ltabsize}|}
\hline
\texttt{super + enter} & Opens a new terminal instance \\ \hline
\texttt{ctrl + shift + w} & Quits a window \\ \hline
\texttt{ctrl + shift + t} & Opens a new tab \\ \hline
\texttt{ctrl + shift + left or right} & Goes to the left/right tab \\ \hline
\texttt{ctrl + shift + enter} & Opens a new terminal window \\ \hline
\texttt{ctrl + shift + ] or [} & Goes to right or left window \\ \hline
\texttt{ctrl + t} & Makes a new tab adjacent to current tab \\ \hline
\end{tabular}

%Seperator
%Seperator
%Seperator
\subsubsection{Window Manager Related}
\begin{comment}
\end{comment}
\begin{tabular}{|m{\tabsize}|m{\ltabsize}|}
\hline
\texttt{super + Num} & Go the the \texttt{Num} workspace \\ \hline
\texttt{super + left or right} & Go to the left or right window in a workspace \\ \hline
\texttt{super + shift + left or right} & move the current window left or right \\ \hline
\texttt{super + shift + up or down} & move the current window up or down \\ \hline
\texttt{super + shift Num} & Move the current window to the \texttt{Num} workspace \\ \hline
\texttt{super + shift + q} & Kill a particular window \\ \hline
\end{tabular}

%Seperator
%Seperator
%Seperator
\subsubsection{Brightness Control}
\begin{comment}
\end{comment}
\begin{tabular}{|m{\tabsize}|m{\ltabsize}|}
\hline
\texttt{alt + y} & Makes screen yellow \\ \hline
\texttt{alt + b} & Makes screen blue \\ \hline
\texttt{alt + F7} & Dims the screen \\ \hline
\texttt{alt + F8} & Brightens Screen \\ \hline
\end{tabular}
